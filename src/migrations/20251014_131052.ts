...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'healthCheck', 'schedulePublish');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'healthCheck', 'schedulePublish');
  CREATE TABLE "posts" (
  ...
  ALTER TABLE "logos" ADD CONSTRAINT "logos_light_mode_icon_id_media_id_fk" FOREIGN KEY ("light_mode_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "logos" ADD CONSTRAINT "logos_light_mode_logo_id_media_id_fk" FOREIGN KEY ("light_mode_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "logos" ADD CONSTRAINT "logos_dark_mode_icon_id_media_id_fk" FOREIGN KEY ("dark_mode_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "logos" ADD CONSTRAINT "logos_dark_mode_logo_id_media_id_fk" FOREIGN KEY ("dark_mode_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "logos_light_mode_icon_idx" ON "logos" USING btree ("light_mode_icon_id");
  CREATE INDEX "logos_light_mode_logo_idx" ON "logos" USING btree ("light_mode_logo_id");
  CREATE INDEX "logos_dark_mode_icon_idx" ON "logos" USING btree ("dark_mode_icon_id");
  CREATE INDEX "logos_dark_mode_logo_idx" ON "logos" USING btree ("dark_mode_logo_id");`)
}
